...
public class CenterSetConf implements Serializable {
    ...
    //整流回复姬
    @JSONField(name="rectifier")
    private RectifierSetConf rectifier;
    //欢迎凝视姬
    ...
    //负黑正白打分姬
    @JSONField(name="pn_score")
    private PnScoreSetConf pnScore;
    ...
    public static CenterSetConf getInitCenterSetConf(){
        ...
        centerSetConf.setPnScore(new PnScoreSetConf());
        return centerSetConf;
    }


    public CenterSetConf(ThankGiftSetConf thank_gift, AdvertSetConf advert,
                         ThankFollowSetConf follow, AutoReplySetConf reply, ClockInSetConf clock_in, ThankWelcomeSetConf welcome, AutoSendGiftConf auto_gift, PrivacySetConf privacy,BlackListSetConf black,LiveStatusSetConf live_status,TimerSetConf timer,DanmakuStoreSetConf danmaku_store,BadListSetConf badList,RectifierSetConf rectifier,GazeWelcomeSetConf gaze_welcome,AutoBlackListSetConf autoBlackList,PnScoreSetConf pnScore) {
        super();
