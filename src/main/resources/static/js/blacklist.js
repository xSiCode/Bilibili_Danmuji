            ...
            if (data.code == "200" && data.result) {
                ...
                try {
                    for (var i = 0; i < r.rows.length; i++) {
                        ...
                        $tr.append($nameTd);
                        $tr.append($("<td>").text(e.score));
                        $tr.append($("<td>").text(e.scoreType || ''));
                        $tr.append($("<td>").text(e.count));
                        // roomId: 点击跳转直播间
                        var $roomTd = $("<td>");
                        ...
                        $tr.append($roomTd);
                        $tr.append($("<td>").text(e.updateTime ? bwlistFmtTs(e.updateTime) : ''));
                        ...
                        $tr.append($("<td>").append($delBtn).append($moveBtn));
                        $tbody.append($tr);
                    }
                    if (r.totalPages > 1) {
                        $pagination.show();
